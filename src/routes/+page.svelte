...
<div class="mesh-bg-gray-900 mesh-w-full mesh-text-white mesh-text-center">
    ...
    >
        ...
        <div class="mesh-mb-20">
            <ConnectWalletButton isDark={true} />
        </div>
        ...
        >
            <a
                ...
                class="mesh-bg-gray-800 mesh-rounded-xl mesh-border mesh-border-white hover:mesh-scale-105 mesh-transition mesh-max-w-96 p-5 mesh-m-5"
            >
